...
{% codeblock lang:java 非空块：K & R 风格 %}
return new MyClass() {
...
{% codeblock lang:java 空块：可以用简洁版本 %}
void doNothing() {}
{% endcodeblock %}
...
{% codeblock lang:java 数组初始化：可写成块状结构%}
new int[] {
  0, 1, 2, 3 
}
...
{% codeblock lang:java Fall-through：注释%}
switch (input) {
  case 1:
  case 2:
    prepareOneOrTwo();
